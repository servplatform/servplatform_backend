...
export async function createTookanTask(snapshot, context) {
    ...
    const options = {
        ...
        job_pickup_email:newValue.customer_email,
        job_pickup_name:newValue.customer_username,
        job_pickup_phone:newValue.customer_phone,
        job_pickup_address:newValue.customer_address,
        job_pickup_latitude:newValue.latitude,
        job_pickup_longitude:newValue.longitude,
        job_pickup_datetime:newValue.job_delivery_datetime,
        pickup_custom_field_template:newValue.custom_field_template,
