...
export const onCreateMessage = functions.firestore
    ...
    .onCreate((snapshot,context) => {
        ...
        return CmFunctions.createMsgJob(snapshot,context,'message');
    });

export const onCreateServiceName = functions.firestore
    .document('services/{serviceId}')
    .onCreate((snapshot,context) => {
        console.log("onCreateMessageTriggered",)
        return CmFunctions.createMsgJob(snapshot,context,'serviceName');
    });

export const onCreateServiceDescription = functions.firestore
    .document('services/{serviceId}')
    .onCreate((snapshot,context) => {
        console.log("onCreateMessageTriggered",)
